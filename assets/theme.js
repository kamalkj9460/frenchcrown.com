...
//                       $('.buy-now-1').hide();
      ...
      value: function _updateAddToCartButton(newVariant) {
        ...
        if (!newVariant) {
          if(meta.product.type != 'Suit' && meta.product.type != 'Trenchcoat Suit'){
...
//                   }
          ...
          }else if(meta.product.type == 'Suit' || meta.product.type == 'Trenchcoat Suit'){
            var pant_size = '';
          	$('.ProductForm__Item').each(function(index){
        ...
        if(addToCartButton.getAttribute('disabled') == null){
          ...
          if($('.extra_pair:checked').length > 0){
            ...
            if(variantObj != undefined){
              ...
              extra_pair_hash = {
                "US28 / EU44" : 34424619565196,
                "US30 / EU46" : 34424619597964,
                "US32 / EU48" : 34424619630732,
                "US34 / EU50" : 34424619663500,
                "US36 / EU52" : 34424619696268,
                "US38 / EU54" : 34424619729036,
                "US40 / EU56" : 34424619761804,
                "US42 / EU58" : 34424619794572,
                "US44 / EU60" : 34424619827340,
                "US46 / EU62" : 34460797108364,
              }
            }
          ...
          if($('.button_vest:checked').length > 0){
            ...
            if(variantObj != undefined){
              ...
              var button_vest_hash = {
                  "US36 / UK36 / EU46 / XS" : 39323069972620,
                  "US38 / UK38 / EU48 / S" : 39323070005388,
                  "US40 / UK40 / EU50 / M" : 39323070038156,
                  "US42 / UK42 / EU52 / L" : 39323070070924,
                  "US44 / UK44 / EU54 / L" : 39323070103692,
                  "US46 / UK46 / EU56 / XL" : 39323070136460,
                  "US48 / UK48 / EU58 / XXL" : 39323070169228,
                  "US50 / UK50 / EU60 / XXL" : 39323070201996,
                  "US52 / UK52 / EU62 / 3XL" : 39323070234764,
                  "US54 / UK54 / EU64 / 3XL" : 39323070267532,
                  "US56 / UK56 / EU66 / 4XL" : 39323070300300,
                  "US58 / UK58 / EU68 / 4XL" : 39323070333068,
              }
            }
            
            console.log('button_vest_hash==>', button_vest_hash);
